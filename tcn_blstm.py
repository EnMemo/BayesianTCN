...
class NN(nn.Module):
    def __init__(self):
        ...
        self.tcn = TemporalConvNet(25, [32,16,8,4], kernel_size=2, dropout=0)
        self.lstm_1 = BayesianLSTM(4, 50, prior_sigma_1=1, prior_pi=1, posterior_rho_init=-3.0)
...
# )
# plt.legend()
# plt.savefig('./tcn_blstm_sequence')
